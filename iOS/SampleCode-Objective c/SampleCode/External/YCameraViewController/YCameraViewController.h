...
typedef void (^FinishPickingImageAction) (UIImage *image);
...
@property (nonatomic, copy) FinishPickingImageAction didFinishPickingImageHandler;
...
- (void)didFinishPickingImage:(UIImage *)image Controller:(YCameraViewController *)controller;
