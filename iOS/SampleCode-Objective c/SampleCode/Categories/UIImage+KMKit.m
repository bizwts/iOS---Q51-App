             ...
             atPoint:(CGPoint)   point
{
    ...
    [text drawInRect:CGRectIntegral(rect) withAttributes:@{NSFontAttributeName: font, NSForegroundColorAttributeName: [UIColor colorWithRed:0.920 green:0.420 blue:0.036 alpha:1.000]}];
